class Library:
    ...
    def __str__(self):
        return(f'Library is located at: {self.zip_code} {self.city} {self.street}.\n'
...
class Book:
    ...
    def __str__(self):
        return(f'You can find book in: {self.library}\n'
              f'Book info:\n' 
...
employee1= Employee("Marek", "Komarek", "12-1-2023", "1-1-2000", "Poznan", "Mikolowska")
employee2 = Employee("Marianna", "Kocioł", "1-12-2013", "12-11-1990", "Warszawa", "Bankowa")
